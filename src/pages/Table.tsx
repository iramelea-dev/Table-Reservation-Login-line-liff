            ...
            {selected && (
              <div style={{ padding: 16, display: "grid", gap: 12 }}>
                ...
                <IonItem>
                  ...
                  >
                    <IonSelectOption value="ว่าง">AVAILABLE</IonSelectOption>
                    <IonSelectOption value="จองแล้ว">RESERVED</IonSelectOption>
                    <IonSelectOption value="ไม่ว่าง">OCCUPIED</IonSelectOption>
                  </IonSelect>
                </IonItem>
